...
// GET all events
router.get('/events', (req, res) => Event
...
router.put('/events/:id', (req, res) => Event
  .updateEvent(req.body, { id: req.params.id }, info => res.json(info)))

// DELETE one event
router.delete('/events/:id', (req, res) => Event
  .deleteEvent({ id: req.params.id }, info => res.json(info)))
