...
// GET all usercarts
router.get('/usercarts', (req, res) => Usercart
  .getUsercarts(usercarts => res.json(usercarts)))
...
router.put('/usercarts/:id', (req, res) => Usercart
  .updateUsercart(req.body, { id: req.params.id }, info => res.json(info)))

// DELETE one usercart
router.delete('/usercarts/:id', (req, res) => Usercart
  .deleteUsercart({ id: req.params.id }, info => res.json(info)))
